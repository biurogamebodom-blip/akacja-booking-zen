...
const translations: Record<Language, Record<string, string>> = {
  pl: {
    ...
    "hero.subtitle": "Komfortowe apartamenty dwupoziomowe nad Bałtykiem. Idealne miejsce na wypoczynek dla całej rodziny.",
...
Nie czekaj! Zarezerwuj już teraz swój pobyt nad Bałtykiem!`,
    ...
    // Footer
    "footer.description": "Komfortowe apartamenty dwupoziomowe nad Bałtykiem. Idealne miejsce na wypoczynek dla całej rodziny.",
  ...
  en: {
    ...
    "hero.titleAccent": "Akacja",
    "hero.subtitle": "Comfortable two-story apartments by the Baltic Sea. The perfect place for a family vacation.",
...
Don't wait! Book your Baltic Sea getaway now!`,
    ...
    // Footer
    "footer.description": "Comfortable two-story apartments by the Baltic Sea. The perfect place for a family vacation.",
