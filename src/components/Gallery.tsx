...
// Gallery images
import gallery01 from "@/assets/gallery/01-widok-zewnetrzny-v2.jpg?format=webp&w=800";
import gallery02 from "@/assets/gallery/02-kuchnia-v2.jpeg?format=webp&w=800";
