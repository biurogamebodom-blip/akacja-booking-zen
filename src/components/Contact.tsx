...
const Contact = () => {
  ...
  return (
    <section id="kontakt" className="section-padding gradient-sand">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card p-6 rounded-xl shadow-soft">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    href={phoneLink}
                    className="text-2xl font-bold text-accent hover:text-accent/80 transition-colors focus-ring rounded"
                  >
            ...
            <Button asChild variant="hero" size="xl" className="w-full">
              <a href={phoneLink}>
                ...
                Zadzwoń teraz: {globalSettings.mainContactPhone}
              </a>
            </Button>
          </div>
