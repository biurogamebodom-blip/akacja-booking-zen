  ...
  return (
    <section id="opinie" className="section-padding bg-background">
      <div className="container-wide mx-auto">
        ...
        {/* ==================== SEKCJA 1: Opinie Statyczne (Nocowanie.pl) ==================== */}
        <div className="mb-16">
          ...
          {/* Trust Indicators for Nocowanie.pl */}
        ...
        {/* ==================== SEKCJA 2: Opinie Google (Trustindex Widget) ==================== */}
        <div className="pt-8 border-t border-border/30">
          ...
          {/* Trustindex Widget Container - Custom HTML Block */}
          <div 
